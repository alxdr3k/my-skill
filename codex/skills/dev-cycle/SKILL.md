...
- 최대 5회 반복한다. 5회 후 남은 actionable finding은 GitHub issue로 남기고 Step 7로 간다. pass 횟수는 매 pass 시작 시 `update_plan` 체크박스 또는 `.dev-cycle/review-pass-count`에 기록해 context reset 이후에도 복원할 수 있도록 한다.
